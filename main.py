...
async def start(client, message):
    await message.reply_text("**Haye Laki!** Iisoo dir linkiga Muuqaal TikTok, Instagram ama Pinterest si aan kuugu soo dejiyo.")
...
async def handler(client, message):
    ...
    if not any(domain in url for domain in allowed_domains):
        await message.reply_text("❌ Bot-kani wuxuu u gaar yahay kaliya TikTok, Instagram, iyo Pinterest.")
        return
    ...
    try:
        ...
        print(e)
        await msg.edit("❌ Khalad ayaa dhacay: Linkigaas lama soo dejin karo xilligan.")
